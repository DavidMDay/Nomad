...
std::vector<double>
extract_column_and_scale(const std::pair<int, int> sz,
                         const std::vector<std::vector<double>> &R, const int col,
                         double scale) {
...
double ip_mat_row_vec(const std::vector<double> &w,
                      ...
                      const std::vector<std::vector<double>> &Q, const int row,
                      const int first_col) {
  assert(row < sz.first);
...
double ip_vec_mat_column(const std::vector<double> &w,
                         const std::pair<int, int> sz,
                         const std::vector<std::vector<double>> &R, const int first_row,
                         const int column) {
  double innerProduct = 0.0;
...
triu(std::pair<int, int> sz, std::vector<std::vector<double>> &X) {
  auto n = sz.second;
  assert( sz.first >= n );
...
std::vector<double> gemv( std::pair<int, int> sz, const double alpha,
const std::vector<std::vector<double>> &B,
const std::vector<double> &w, const int start) {
...
std::vector<double> gemvt( std::pair<int, int> sz, const double alpha,
                const std::vector<std::vector<double>> &B,
...
std::vector<double> square_matrix_transpose(  const std::vector<double>& B) {
  int n = std::sqrt( static_cast<int>(B.size()) );
